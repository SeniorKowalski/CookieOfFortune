package com.kowalski.prediction.config;
...
@Configuration
@ComponentScan("com.kowalski.prediction")
@PropertySource(value = "classpath:hibernate.properties", encoding = "UTF-8")
@EnableTransactionManagement
@EnableJpaRepositories("com.kowalski.prediction.repositories")
@EnableWebMvc
public class SpringConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
        ...
        em.setPackagesToScan("com.kowalski.prediction.models");
